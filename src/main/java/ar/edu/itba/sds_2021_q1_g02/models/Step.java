...
public class Step {
    ...
    private final BigDecimal leftOccupationFactor;
    private final int particlesOnLeftSide;
    private final int step;

    public Step(TreeMap<Double, EventCollection> nextEvents, Map<Particle, Set<Event>> particleEvents, BigDecimal deltaTime, BigDecimal absoluteTime, int step, int particleCount, int particlesOnLeftSide) {
        ...
        if (particlesOnLeftSide == 0)
            ...
            this.leftOccupationFactor = particlesOnLeftSide / ((BigDecimal) particleCount);
    }
    ...
    public BigDecimal getLeftOccupationFactor() {
